...
from .libreoffice_converter import convert_docx_to_pdf_libreoffice, LibreOfficeConverter
...
__all__ = ['get_brand_lookup', 'validate_cpf', 'validate_vehicle_plate', 'validate_chassis_number', 'sanitize_log_data', 'setup_logging', 'get_logger', 'LoggerMixin', 'TermGeneratorError', 'PDFExtractionError', 'DocumentProcessingError', 'TemplateNotFoundError', 'ValidationError', 'ConfigurationError', 'OCRError', 'BrandLookupError', 'handle_exception', 'convert_docx_to_pdf_libreoffice', 'LibreOfficeConverter', 'format_currency_value']